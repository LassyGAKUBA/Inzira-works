...
function BookingModal({ provider, user, providerPhone, onClose }) {
  ...
  const [form, setForm] = useState({ service: provider.services[0]?.name || "General service request", date: "", time: "", notes: "" });
              ...
              <div className="flex flex-col gap-1.5">
                ...
                >
                  {provider.services.length === 0
                    ? <option value="General service request">General service request</option>
